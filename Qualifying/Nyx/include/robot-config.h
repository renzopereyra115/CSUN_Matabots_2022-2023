...
class robotChasis{
  public:
    ...
    pros::Motor leftFront = pros::Motor(11, pros::E_MOTOR_GEARSET_18, true);

    /// Front Right Motor Instance
    pros::Motor leftMid = pros::Motor(13, pros::E_MOTOR_GEARSET_18, false);
    ...
    pros::Rotation rightTracker = pros::Rotation(9,false);
